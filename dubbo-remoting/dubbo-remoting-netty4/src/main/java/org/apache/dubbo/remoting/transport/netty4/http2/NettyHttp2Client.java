...
// * NettyClient.
// */
//public class NettyHttp2Client extends AbstractClient {
//
...
//
//    /**
//     * current channel. Each successful invocation of {@link NettyHttp2Client#doConnect()} will
...
//     */
//    public NettyHttp2Client(final URL url, final ChannelHandler handler) throws RemotingException {
...
//                    ch.pipeline().addLast("negotiation", SslHandlerInitializer
//                        .sslClientHandler(getUrl(), nettyClientHandler));
//                }
//
...
//                    // Close old channel
//                    // copy reference
//                    Channel oldChannel = NettyHttp2Client.this.channel;
//                    if (oldChannel != null) {
//                        try {
...
//                    }
//                } finally {
//                    if (NettyHttp2Client.this.isClosed()) {
//                        try {
//                            if (logger.isInfoEnabled()) {
...
//                            newChannel.close();
//                        } finally {
//                            NettyHttp2Client.this.channel = null;
//                            NettyChannel.removeChannelIfDisconnected(newChannel);
//                        }
//                    } else {
//                        NettyHttp2Client.this.channel = newChannel;
//                    }
//                }
