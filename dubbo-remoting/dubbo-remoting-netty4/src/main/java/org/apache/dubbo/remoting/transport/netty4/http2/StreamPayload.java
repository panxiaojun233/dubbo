...
public class StreamPayload implements GrpcPacket {
    ...
    public static final ConcurrentHashMap<Long, StreamPayload>
        ID_PAYLOAD_MAP = new ConcurrentHashMap<Long, StreamPayload>(1024);
    ...
    public Map<String, String> getMetadata() {
        attachments().put(":path", String.valueOf(headers.get(":path")));
        return attachments;
    }
